...
if TYPE_CHECKING:
    from ..models.post_workflows_id_unarchive_response_200_nodes_item_credentials import (
        PostWorkflowsIdUnarchiveResponse200NodesItemCredentials,
    )
    from ..models.post_workflows_id_unarchive_response_200_nodes_item_parameters import (
        PostWorkflowsIdUnarchiveResponse200NodesItemParameters,
    )


T = TypeVar("T", bound="PostWorkflowsIdUnarchiveResponse200NodesItem")


@_attrs_define
class PostWorkflowsIdUnarchiveResponse200NodesItem:
    """
    Attributes:
        ...
        parameters (PostWorkflowsIdUnarchiveResponse200NodesItemParameters | Unset):  Example: {'additionalProperties':
            {}}.
        credentials (PostWorkflowsIdUnarchiveResponse200NodesItemCredentials | Unset):  Example:
    ...
    parameters: PostWorkflowsIdUnarchiveResponse200NodesItemParameters | Unset = UNSET
    credentials: PostWorkflowsIdUnarchiveResponse200NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: PostWorkflowsIdUnarchiveResponse200NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = PostWorkflowsIdUnarchiveResponse200NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: PostWorkflowsIdUnarchiveResponse200NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = PostWorkflowsIdUnarchiveResponse200NodesItemCredentials.from_dict(_credentials)
        ...
        post_workflows_id_unarchive_response_200_nodes_item = cls(
            id=id,
            name=name,
        ...
        return post_workflows_id_unarchive_response_200_nodes_item
