...
if TYPE_CHECKING:
    from ..models.delete_workflows_id_response_200_nodes_item_credentials import (
        DeleteWorkflowsIdResponse200NodesItemCredentials,
    )
    from ..models.delete_workflows_id_response_200_nodes_item_parameters import (
        DeleteWorkflowsIdResponse200NodesItemParameters,
    )


T = TypeVar("T", bound="DeleteWorkflowsIdResponse200NodesItem")


@_attrs_define
class DeleteWorkflowsIdResponse200NodesItem:
    """
    Attributes:
        ...
        parameters (DeleteWorkflowsIdResponse200NodesItemParameters | Unset):  Example: {'additionalProperties': {}}.
        credentials (DeleteWorkflowsIdResponse200NodesItemCredentials | Unset):  Example: {'jiraSoftwareCloudApi':
            {'id': '35', 'name': 'jiraApi'}}.
    ...
    parameters: DeleteWorkflowsIdResponse200NodesItemParameters | Unset = UNSET
    credentials: DeleteWorkflowsIdResponse200NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: DeleteWorkflowsIdResponse200NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = DeleteWorkflowsIdResponse200NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: DeleteWorkflowsIdResponse200NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = DeleteWorkflowsIdResponse200NodesItemCredentials.from_dict(_credentials)
        ...
        delete_workflows_id_response_200_nodes_item = cls(
            id=id,
            name=name,
        ...
        return delete_workflows_id_response_200_nodes_item
