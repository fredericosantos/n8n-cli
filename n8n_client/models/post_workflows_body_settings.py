...
from ..models.post_workflows_body_settings_caller_policy import PostWorkflowsBodySettingsCallerPolicy
from ..models.post_workflows_body_settings_save_data_error_execution import (
    PostWorkflowsBodySettingsSaveDataErrorExecution,
)
from ..models.post_workflows_body_settings_save_data_success_execution import (
    PostWorkflowsBodySettingsSaveDataSuccessExecution,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostWorkflowsBodySettings")


@_attrs_define
class PostWorkflowsBodySettings:
    """
    Attributes:
        save_execution_progress (bool | Unset):
        save_manual_executions (bool | Unset):
        save_data_error_execution (PostWorkflowsBodySettingsSaveDataErrorExecution | Unset):
        save_data_success_execution (PostWorkflowsBodySettingsSaveDataSuccessExecution | Unset):
        ...
        caller_policy (PostWorkflowsBodySettingsCallerPolicy | Unset): Controls which workflows are allowed to call this
            workflow using the Execute Workflow node.
            ...
            - `workflowsFromAList`: Only specific workflows listed in the `callerIds` field can call this workflow
             ...
             Default: PostWorkflowsBodySettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER. Example: workflowsFromSameOwner.
    ...
    save_data_error_execution: PostWorkflowsBodySettingsSaveDataErrorExecution | Unset = UNSET
    save_data_success_execution: PostWorkflowsBodySettingsSaveDataSuccessExecution | Unset = UNSET
    execution_timeout: float | Unset = UNSET
    error_workflow: str | Unset = UNSET
    timezone: str | Unset = UNSET
    execution_order: str | Unset = UNSET
    caller_policy: PostWorkflowsBodySettingsCallerPolicy | Unset = (
        PostWorkflowsBodySettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_save_data_error_execution, Unset):
            ...
            save_data_error_execution = PostWorkflowsBodySettingsSaveDataErrorExecution(_save_data_error_execution)
        ...
        if isinstance(_save_data_success_execution, Unset):
            ...
            save_data_success_execution = PostWorkflowsBodySettingsSaveDataSuccessExecution(
        ...
        if isinstance(_caller_policy, Unset):
            ...
            caller_policy = PostWorkflowsBodySettingsCallerPolicy(_caller_policy)
        ...
        post_workflows_body_settings = cls(
        ...
        return post_workflows_body_settings
