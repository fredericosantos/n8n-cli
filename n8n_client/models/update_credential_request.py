...
if TYPE_CHECKING:
    from ..models.update_credential_request_data import UpdateCredentialRequestData
...
class UpdateCredentialRequest:
    ...
    Attributes:
        ...
        data (UpdateCredentialRequestData | Unset): The credential data. Required when changing credential type.
    ...
    data: UpdateCredentialRequestData | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: UpdateCredentialRequestData | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = UpdateCredentialRequestData.from_dict(_data)
        ...
        update_credential_request.additional_properties = d
