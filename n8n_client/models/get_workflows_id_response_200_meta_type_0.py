...
T = TypeVar("T", bound="GetWorkflowsIdResponse200MetaType0")


@_attrs_define
class GetWorkflowsIdResponse200MetaType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_workflows_id_response_200_meta_type_0 = cls(
        ...
        get_workflows_id_response_200_meta_type_0.additional_properties = d
        return get_workflows_id_response_200_meta_type_0
