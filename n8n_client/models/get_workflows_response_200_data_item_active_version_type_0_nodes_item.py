...
if TYPE_CHECKING:
    from ..models.get_workflows_response_200_data_item_active_version_type_0_nodes_item_credentials import (
        GetWorkflowsResponse200DataItemActiveVersionType0NodesItemCredentials,
    )
    from ..models.get_workflows_response_200_data_item_active_version_type_0_nodes_item_parameters import (
        GetWorkflowsResponse200DataItemActiveVersionType0NodesItemParameters,
    )


T = TypeVar("T", bound="GetWorkflowsResponse200DataItemActiveVersionType0NodesItem")


@_attrs_define
class GetWorkflowsResponse200DataItemActiveVersionType0NodesItem:
    """
    Attributes:
        ...
        parameters (GetWorkflowsResponse200DataItemActiveVersionType0NodesItemParameters | Unset):  Example:
            {'additionalProperties': {}}.
        credentials (GetWorkflowsResponse200DataItemActiveVersionType0NodesItemCredentials | Unset):  Example:
    ...
    parameters: GetWorkflowsResponse200DataItemActiveVersionType0NodesItemParameters | Unset = UNSET
    credentials: GetWorkflowsResponse200DataItemActiveVersionType0NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: GetWorkflowsResponse200DataItemActiveVersionType0NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = GetWorkflowsResponse200DataItemActiveVersionType0NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: GetWorkflowsResponse200DataItemActiveVersionType0NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = GetWorkflowsResponse200DataItemActiveVersionType0NodesItemCredentials.from_dict(_credentials)
        ...
        get_workflows_response_200_data_item_active_version_type_0_nodes_item = cls(
            id=id,
            name=name,
        ...
        return get_workflows_response_200_data_item_active_version_type_0_nodes_item
