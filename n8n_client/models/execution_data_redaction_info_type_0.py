...
T = TypeVar("T", bound="ExecutionDataRedactionInfoType0")


@_attrs_define
class ExecutionDataRedactionInfoType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        execution_data_redaction_info_type_0 = cls(
            is_redacted=is_redacted,
            reason=reason,
            can_reveal=can_reveal,
        )

        execution_data_redaction_info_type_0.additional_properties = d
        return execution_data_redaction_info_type_0
