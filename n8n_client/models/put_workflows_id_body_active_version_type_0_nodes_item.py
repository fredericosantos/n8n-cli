...
if TYPE_CHECKING:
    from ..models.put_workflows_id_body_active_version_type_0_nodes_item_credentials import (
        PutWorkflowsIdBodyActiveVersionType0NodesItemCredentials,
    )
    from ..models.put_workflows_id_body_active_version_type_0_nodes_item_parameters import (
        PutWorkflowsIdBodyActiveVersionType0NodesItemParameters,
    )


T = TypeVar("T", bound="PutWorkflowsIdBodyActiveVersionType0NodesItem")


@_attrs_define
class PutWorkflowsIdBodyActiveVersionType0NodesItem:
    """
    Attributes:
        ...
        parameters (PutWorkflowsIdBodyActiveVersionType0NodesItemParameters | Unset):  Example: {'additionalProperties':
            {}}.
        credentials (PutWorkflowsIdBodyActiveVersionType0NodesItemCredentials | Unset):  Example:
    ...
    parameters: PutWorkflowsIdBodyActiveVersionType0NodesItemParameters | Unset = UNSET
    credentials: PutWorkflowsIdBodyActiveVersionType0NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: PutWorkflowsIdBodyActiveVersionType0NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = PutWorkflowsIdBodyActiveVersionType0NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: PutWorkflowsIdBodyActiveVersionType0NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = PutWorkflowsIdBodyActiveVersionType0NodesItemCredentials.from_dict(_credentials)
        ...
        put_workflows_id_body_active_version_type_0_nodes_item = cls(
            id=id,
            name=name,
        ...
        return put_workflows_id_body_active_version_type_0_nodes_item
