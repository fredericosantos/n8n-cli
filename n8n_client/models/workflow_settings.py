...
from ..models.workflow_settings_caller_policy import WorkflowSettingsCallerPolicy
from ..models.workflow_settings_save_data_error_execution import WorkflowSettingsSaveDataErrorExecution
from ..models.workflow_settings_save_data_success_execution import WorkflowSettingsSaveDataSuccessExecution
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowSettings")
...
class WorkflowSettings:
    ...
    Attributes:
        ...
        save_data_error_execution (WorkflowSettingsSaveDataErrorExecution | Unset):
        save_data_success_execution (WorkflowSettingsSaveDataSuccessExecution | Unset):
        ...
        caller_policy (WorkflowSettingsCallerPolicy | Unset): Controls which workflows are allowed to call this workflow
            ...
            - `workflowsFromAList`: Only specific workflows listed in the `callerIds` field can call this workflow
             ...
             Default: WorkflowSettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER. Example: workflowsFromSameOwner.
    ...
    save_data_error_execution: WorkflowSettingsSaveDataErrorExecution | Unset = UNSET
    save_data_success_execution: WorkflowSettingsSaveDataSuccessExecution | Unset = UNSET
    execution_timeout: float | Unset = UNSET
    error_workflow: str | Unset = UNSET
    timezone: str | Unset = UNSET
    execution_order: str | Unset = UNSET
    caller_policy: WorkflowSettingsCallerPolicy | Unset = WorkflowSettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_save_data_error_execution, Unset):
            ...
            save_data_error_execution = WorkflowSettingsSaveDataErrorExecution(_save_data_error_execution)
        ...
        if isinstance(_save_data_success_execution, Unset):
            ...
            save_data_success_execution = WorkflowSettingsSaveDataSuccessExecution(_save_data_success_execution)
        ...
        caller_policy: WorkflowSettingsCallerPolicy | Unset
        if isinstance(_caller_policy, Unset):
            caller_policy = UNSET
        else:
            caller_policy = WorkflowSettingsCallerPolicy(_caller_policy)
