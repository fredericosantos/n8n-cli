...
if TYPE_CHECKING:
    from ..models.post_workflows_id_deactivate_response_200_nodes_item_credentials import (
        PostWorkflowsIdDeactivateResponse200NodesItemCredentials,
    )
    from ..models.post_workflows_id_deactivate_response_200_nodes_item_parameters import (
        PostWorkflowsIdDeactivateResponse200NodesItemParameters,
    )


T = TypeVar("T", bound="PostWorkflowsIdDeactivateResponse200NodesItem")


@_attrs_define
class PostWorkflowsIdDeactivateResponse200NodesItem:
    """
    Attributes:
        ...
        parameters (PostWorkflowsIdDeactivateResponse200NodesItemParameters | Unset):  Example: {'additionalProperties':
            {}}.
        credentials (PostWorkflowsIdDeactivateResponse200NodesItemCredentials | Unset):  Example:
    ...
    parameters: PostWorkflowsIdDeactivateResponse200NodesItemParameters | Unset = UNSET
    credentials: PostWorkflowsIdDeactivateResponse200NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: PostWorkflowsIdDeactivateResponse200NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = PostWorkflowsIdDeactivateResponse200NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: PostWorkflowsIdDeactivateResponse200NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = PostWorkflowsIdDeactivateResponse200NodesItemCredentials.from_dict(_credentials)
        ...
        post_workflows_id_deactivate_response_200_nodes_item = cls(
            id=id,
            name=name,
        ...
        return post_workflows_id_deactivate_response_200_nodes_item
