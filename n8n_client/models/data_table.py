...
if TYPE_CHECKING:
    from ..models.data_table_columns_item import DataTableColumnsItem
...
class DataTable:
    ...
    Attributes:
        ...
        columns (list[DataTableColumnsItem]): Column definitions
    ...
    id: str
    name: str
    columns: list[DataTableColumnsItem]
    project_id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for columns_item_data in _columns:
            columns_item = DataTableColumnsItem.from_dict(columns_item_data)
