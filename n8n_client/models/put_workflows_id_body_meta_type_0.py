...
T = TypeVar("T", bound="PutWorkflowsIdBodyMetaType0")


@_attrs_define
class PutWorkflowsIdBodyMetaType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_workflows_id_body_meta_type_0 = cls(
        ...
        put_workflows_id_body_meta_type_0.additional_properties = d
        return put_workflows_id_body_meta_type_0
