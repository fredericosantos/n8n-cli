...
if TYPE_CHECKING:
    from ..models.delete_credential_response_200_data import DeleteCredentialResponse200Data


T = TypeVar("T", bound="DeleteCredentialResponse200")


@_attrs_define
class DeleteCredentialResponse200:
    """
    Attributes:
        name (str):  Example: Joe's Github Credentials.
        type_ (str):  Example: githubApi.
        data (DeleteCredentialResponse200Data):  Example: {'accessToken': 'ada612vad6fa5df4adf5a5dsf4389adsf76da7s'}.
    ...
    name: str
    type_: str
    data: DeleteCredentialResponse200Data
    id: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data = DeleteCredentialResponse200Data.from_dict(d.pop("data"))
        ...
        delete_credential_response_200 = cls(
            name=name,
            type_=type_,
            data=data,
            id=id,
        ...
        delete_credential_response_200.additional_properties = d
        return delete_credential_response_200
