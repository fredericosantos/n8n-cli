...
if TYPE_CHECKING:
    from ..models.post_workflows_id_archive_response_200_active_version_type_0_nodes_item_credentials import (
        PostWorkflowsIdArchiveResponse200ActiveVersionType0NodesItemCredentials,
    )
    from ..models.post_workflows_id_archive_response_200_active_version_type_0_nodes_item_parameters import (
        PostWorkflowsIdArchiveResponse200ActiveVersionType0NodesItemParameters,
    )


T = TypeVar("T", bound="PostWorkflowsIdArchiveResponse200ActiveVersionType0NodesItem")


@_attrs_define
class PostWorkflowsIdArchiveResponse200ActiveVersionType0NodesItem:
    """
    Attributes:
        ...
        parameters (PostWorkflowsIdArchiveResponse200ActiveVersionType0NodesItemParameters | Unset):  Example:
            {'additionalProperties': {}}.
        credentials (PostWorkflowsIdArchiveResponse200ActiveVersionType0NodesItemCredentials | Unset):  Example:
    ...
    parameters: PostWorkflowsIdArchiveResponse200ActiveVersionType0NodesItemParameters | Unset = UNSET
    credentials: PostWorkflowsIdArchiveResponse200ActiveVersionType0NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: PostWorkflowsIdArchiveResponse200ActiveVersionType0NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = PostWorkflowsIdArchiveResponse200ActiveVersionType0NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: PostWorkflowsIdArchiveResponse200ActiveVersionType0NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = PostWorkflowsIdArchiveResponse200ActiveVersionType0NodesItemCredentials.from_dict(
                _credentials
            )
        ...
        post_workflows_id_archive_response_200_active_version_type_0_nodes_item = cls(
            id=id,
            name=name,
        ...
        return post_workflows_id_archive_response_200_active_version_type_0_nodes_item
