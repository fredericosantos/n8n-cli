...
T = TypeVar("T", bound="PostAuditResponse200CredentialsRiskReport")


@_attrs_define
class PostAuditResponse200CredentialsRiskReport:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        post_audit_response_200_credentials_risk_report = cls()

        post_audit_response_200_credentials_risk_report.additional_properties = d
        return post_audit_response_200_credentials_risk_report
