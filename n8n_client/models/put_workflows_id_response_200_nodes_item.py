...
if TYPE_CHECKING:
    from ..models.put_workflows_id_response_200_nodes_item_credentials import (
        PutWorkflowsIdResponse200NodesItemCredentials,
    )
    from ..models.put_workflows_id_response_200_nodes_item_parameters import (
        PutWorkflowsIdResponse200NodesItemParameters,
    )


T = TypeVar("T", bound="PutWorkflowsIdResponse200NodesItem")


@_attrs_define
class PutWorkflowsIdResponse200NodesItem:
    """
    Attributes:
        ...
        parameters (PutWorkflowsIdResponse200NodesItemParameters | Unset):  Example: {'additionalProperties': {}}.
        credentials (PutWorkflowsIdResponse200NodesItemCredentials | Unset):  Example: {'jiraSoftwareCloudApi': {'id':
            '35', 'name': 'jiraApi'}}.
    ...
    parameters: PutWorkflowsIdResponse200NodesItemParameters | Unset = UNSET
    credentials: PutWorkflowsIdResponse200NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: PutWorkflowsIdResponse200NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = PutWorkflowsIdResponse200NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: PutWorkflowsIdResponse200NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = PutWorkflowsIdResponse200NodesItemCredentials.from_dict(_credentials)
        ...
        put_workflows_id_response_200_nodes_item = cls(
            id=id,
            name=name,
        ...
        return put_workflows_id_response_200_nodes_item
