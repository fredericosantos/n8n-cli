...
if TYPE_CHECKING:
    from ..models.get_workflows_id_version_id_response_200_nodes_item_credentials import (
        GetWorkflowsIdVersionIdResponse200NodesItemCredentials,
    )
    from ..models.get_workflows_id_version_id_response_200_nodes_item_parameters import (
        GetWorkflowsIdVersionIdResponse200NodesItemParameters,
    )


T = TypeVar("T", bound="GetWorkflowsIdVersionIdResponse200NodesItem")


@_attrs_define
class GetWorkflowsIdVersionIdResponse200NodesItem:
    """
    Attributes:
        ...
        parameters (GetWorkflowsIdVersionIdResponse200NodesItemParameters | Unset):  Example: {'additionalProperties':
            {}}.
        credentials (GetWorkflowsIdVersionIdResponse200NodesItemCredentials | Unset):  Example: {'jiraSoftwareCloudApi':
            {'id': '35', 'name': 'jiraApi'}}.
    ...
    parameters: GetWorkflowsIdVersionIdResponse200NodesItemParameters | Unset = UNSET
    credentials: GetWorkflowsIdVersionIdResponse200NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: GetWorkflowsIdVersionIdResponse200NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = GetWorkflowsIdVersionIdResponse200NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: GetWorkflowsIdVersionIdResponse200NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = GetWorkflowsIdVersionIdResponse200NodesItemCredentials.from_dict(_credentials)
        ...
        get_workflows_id_version_id_response_200_nodes_item = cls(
            id=id,
            name=name,
        ...
        return get_workflows_id_version_id_response_200_nodes_item
