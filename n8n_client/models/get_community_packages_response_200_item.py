...
if TYPE_CHECKING:
    from ..models.get_community_packages_response_200_item_installed_nodes_item import (
        GetCommunityPackagesResponse200ItemInstalledNodesItem,
    )


T = TypeVar("T", bound="GetCommunityPackagesResponse200Item")


@_attrs_define
class GetCommunityPackagesResponse200Item:
    """
    Attributes:
        ...
        installed_nodes (list[GetCommunityPackagesResponse200ItemInstalledNodesItem] | Unset): Nodes included in this
            package
    ...
    installed_nodes: list[GetCommunityPackagesResponse200ItemInstalledNodesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _installed_nodes is not UNSET:
            ...
            for installed_nodes_item_data in _installed_nodes:
                installed_nodes_item = GetCommunityPackagesResponse200ItemInstalledNodesItem.from_dict(
        ...
        get_community_packages_response_200_item = cls(
        ...
        get_community_packages_response_200_item.additional_properties = d
        return get_community_packages_response_200_item
