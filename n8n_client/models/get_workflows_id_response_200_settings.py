...
from ..models.get_workflows_id_response_200_settings_caller_policy import GetWorkflowsIdResponse200SettingsCallerPolicy
from ..models.get_workflows_id_response_200_settings_save_data_error_execution import (
    GetWorkflowsIdResponse200SettingsSaveDataErrorExecution,
)
from ..models.get_workflows_id_response_200_settings_save_data_success_execution import (
    GetWorkflowsIdResponse200SettingsSaveDataSuccessExecution,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetWorkflowsIdResponse200Settings")


@_attrs_define
class GetWorkflowsIdResponse200Settings:
    """
    Attributes:
        save_execution_progress (bool | Unset):
        save_manual_executions (bool | Unset):
        save_data_error_execution (GetWorkflowsIdResponse200SettingsSaveDataErrorExecution | Unset):
        save_data_success_execution (GetWorkflowsIdResponse200SettingsSaveDataSuccessExecution | Unset):
        ...
        caller_policy (GetWorkflowsIdResponse200SettingsCallerPolicy | Unset): Controls which workflows are allowed to
            ...
            - `workflowsFromAList`: Only specific workflows listed in the `callerIds` field can call this workflow
             ...
             Default: GetWorkflowsIdResponse200SettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER. Example: workflowsFromSameOwner.
    ...
    save_data_error_execution: GetWorkflowsIdResponse200SettingsSaveDataErrorExecution | Unset = UNSET
    save_data_success_execution: GetWorkflowsIdResponse200SettingsSaveDataSuccessExecution | Unset = UNSET
    execution_timeout: float | Unset = UNSET
    error_workflow: str | Unset = UNSET
    timezone: str | Unset = UNSET
    execution_order: str | Unset = UNSET
    caller_policy: GetWorkflowsIdResponse200SettingsCallerPolicy | Unset = (
        GetWorkflowsIdResponse200SettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_save_data_error_execution, Unset):
            ...
            save_data_error_execution = GetWorkflowsIdResponse200SettingsSaveDataErrorExecution(
        ...
        if isinstance(_save_data_success_execution, Unset):
            ...
            save_data_success_execution = GetWorkflowsIdResponse200SettingsSaveDataSuccessExecution(
        ...
        if isinstance(_caller_policy, Unset):
            ...
            caller_policy = GetWorkflowsIdResponse200SettingsCallerPolicy(_caller_policy)
        ...
        get_workflows_id_response_200_settings = cls(
        ...
        return get_workflows_id_response_200_settings
