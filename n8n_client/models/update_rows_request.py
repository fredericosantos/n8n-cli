...
if TYPE_CHECKING:
    from ..models.update_rows_request_data import UpdateRowsRequestData
    from ..models.update_rows_request_filter import UpdateRowsRequestFilter
...
class UpdateRowsRequest:
    """
    Attributes:
        filter_ (UpdateRowsRequestFilter): Filter conditions to match rows for update
        data (UpdateRowsRequestData): Column values to update
    ...
    filter_: UpdateRowsRequestFilter
    data: UpdateRowsRequestData
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        filter_ = UpdateRowsRequestFilter.from_dict(d.pop("filter"))

        data = UpdateRowsRequestData.from_dict(d.pop("data"))
