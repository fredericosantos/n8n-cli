...
from ..models.delete_executions_id_response_200_mode import DeleteExecutionsIdResponse200Mode
from ..models.delete_executions_id_response_200_status import DeleteExecutionsIdResponse200Status
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.delete_executions_id_response_200_custom_data import DeleteExecutionsIdResponse200CustomData
    from ..models.delete_executions_id_response_200_data import DeleteExecutionsIdResponse200Data


T = TypeVar("T", bound="DeleteExecutionsIdResponse200")


@_attrs_define
class DeleteExecutionsIdResponse200:
    """
    Attributes:
        id (float | Unset):  Example: 1000.
        data (DeleteExecutionsIdResponse200Data | Unset): Detailed execution data. Only included when `includeData` is
            `true`.
        finished (bool | Unset):  Example: True.
        mode (DeleteExecutionsIdResponse200Mode | Unset):
        ...
        custom_data (DeleteExecutionsIdResponse200CustomData | Unset):
        status (DeleteExecutionsIdResponse200Status | Unset):
    """

    id: float | Unset = UNSET
    data: DeleteExecutionsIdResponse200Data | Unset = UNSET
    finished: bool | Unset = UNSET
    mode: DeleteExecutionsIdResponse200Mode | Unset = UNSET
    ...
    custom_data: DeleteExecutionsIdResponse200CustomData | Unset = UNSET
    status: DeleteExecutionsIdResponse200Status | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: DeleteExecutionsIdResponse200Data | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = DeleteExecutionsIdResponse200Data.from_dict(_data)
        ...
        if isinstance(_mode, Unset):
            ...
            mode = DeleteExecutionsIdResponse200Mode(_mode)
        ...
        if isinstance(_custom_data, Unset):
            ...
            custom_data = DeleteExecutionsIdResponse200CustomData.from_dict(_custom_data)
        ...
        if isinstance(_status, Unset):
            ...
            status = DeleteExecutionsIdResponse200Status(_status)

        delete_executions_id_response_200 = cls(
            id=id,
            data=data,
            finished=finished,
            mode=mode,
        ...
        delete_executions_id_response_200.additional_properties = d
        return delete_executions_id_response_200
