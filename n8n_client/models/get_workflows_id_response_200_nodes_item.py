...
if TYPE_CHECKING:
    from ..models.get_workflows_id_response_200_nodes_item_credentials import (
        GetWorkflowsIdResponse200NodesItemCredentials,
    )
    from ..models.get_workflows_id_response_200_nodes_item_parameters import (
        GetWorkflowsIdResponse200NodesItemParameters,
    )


T = TypeVar("T", bound="GetWorkflowsIdResponse200NodesItem")


@_attrs_define
class GetWorkflowsIdResponse200NodesItem:
    """
    Attributes:
        ...
        parameters (GetWorkflowsIdResponse200NodesItemParameters | Unset):  Example: {'additionalProperties': {}}.
        credentials (GetWorkflowsIdResponse200NodesItemCredentials | Unset):  Example: {'jiraSoftwareCloudApi': {'id':
            '35', 'name': 'jiraApi'}}.
    ...
    parameters: GetWorkflowsIdResponse200NodesItemParameters | Unset = UNSET
    credentials: GetWorkflowsIdResponse200NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: GetWorkflowsIdResponse200NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = GetWorkflowsIdResponse200NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: GetWorkflowsIdResponse200NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = GetWorkflowsIdResponse200NodesItemCredentials.from_dict(_credentials)
        ...
        get_workflows_id_response_200_nodes_item = cls(
            id=id,
            name=name,
        ...
        return get_workflows_id_response_200_nodes_item
