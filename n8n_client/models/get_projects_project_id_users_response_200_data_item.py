...
T = TypeVar("T", bound="GetProjectsProjectIdUsersResponse200DataItem")


@_attrs_define
class GetProjectsProjectIdUsersResponse200DataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_projects_project_id_users_response_200_data_item = cls(
            id=id,
            email=email,
        ...
        get_projects_project_id_users_response_200_data_item.additional_properties = d
        return get_projects_project_id_users_response_200_data_item
