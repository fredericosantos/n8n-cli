...
T = TypeVar("T", bound="CreateCredentialResponse")
...
class CreateCredentialResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_credential_response = cls(
            id=id,
            name=name,
            type_=type_,
        ...
        create_credential_response.additional_properties = d
        return create_credential_response
