...
T = TypeVar("T", bound="WorkflowMetaType0")


@_attrs_define
class WorkflowMetaType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workflow_meta_type_0.additional_properties = d
        return workflow_meta_type_0
