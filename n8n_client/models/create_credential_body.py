...
if TYPE_CHECKING:
    from ..models.create_credential_body_data import CreateCredentialBodyData
...
class CreateCredentialBody:
    ...
    Attributes:
        ...
        data (CreateCredentialBodyData):  Example: {'accessToken': 'ada612vad6fa5df4adf5a5dsf4389adsf76da7s'}.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data = CreateCredentialBodyData.from_dict(d.pop("data"))
