...
T = TypeVar("T", bound="PutWorkflowsIdResponse200MetaType0")


@_attrs_define
class PutWorkflowsIdResponse200MetaType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_workflows_id_response_200_meta_type_0 = cls(
        ...
        put_workflows_id_response_200_meta_type_0.additional_properties = d
        return put_workflows_id_response_200_meta_type_0
