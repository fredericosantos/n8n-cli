...
if TYPE_CHECKING:
    from ..models.post_workflows_id_activate_response_200_nodes_item_credentials import (
        PostWorkflowsIdActivateResponse200NodesItemCredentials,
    )
    from ..models.post_workflows_id_activate_response_200_nodes_item_parameters import (
        PostWorkflowsIdActivateResponse200NodesItemParameters,
    )


T = TypeVar("T", bound="PostWorkflowsIdActivateResponse200NodesItem")


@_attrs_define
class PostWorkflowsIdActivateResponse200NodesItem:
    """
    Attributes:
        ...
        parameters (PostWorkflowsIdActivateResponse200NodesItemParameters | Unset):  Example: {'additionalProperties':
            {}}.
        credentials (PostWorkflowsIdActivateResponse200NodesItemCredentials | Unset):  Example: {'jiraSoftwareCloudApi':
            {'id': '35', 'name': 'jiraApi'}}.
    ...
    parameters: PostWorkflowsIdActivateResponse200NodesItemParameters | Unset = UNSET
    credentials: PostWorkflowsIdActivateResponse200NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: PostWorkflowsIdActivateResponse200NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = PostWorkflowsIdActivateResponse200NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: PostWorkflowsIdActivateResponse200NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = PostWorkflowsIdActivateResponse200NodesItemCredentials.from_dict(_credentials)
        ...
        post_workflows_id_activate_response_200_nodes_item = cls(
            id=id,
            name=name,
        ...
        return post_workflows_id_activate_response_200_nodes_item
