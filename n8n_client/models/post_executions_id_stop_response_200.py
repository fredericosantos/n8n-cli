...
from ..models.post_executions_id_stop_response_200_mode import PostExecutionsIdStopResponse200Mode
from ..models.post_executions_id_stop_response_200_status import PostExecutionsIdStopResponse200Status
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_executions_id_stop_response_200_custom_data import PostExecutionsIdStopResponse200CustomData
    from ..models.post_executions_id_stop_response_200_data import PostExecutionsIdStopResponse200Data


T = TypeVar("T", bound="PostExecutionsIdStopResponse200")


@_attrs_define
class PostExecutionsIdStopResponse200:
    """
    Attributes:
        id (float | Unset):  Example: 1000.
        data (PostExecutionsIdStopResponse200Data | Unset): Detailed execution data. Only included when `includeData` is
            `true`.
        finished (bool | Unset):  Example: True.
        mode (PostExecutionsIdStopResponse200Mode | Unset):
        ...
        custom_data (PostExecutionsIdStopResponse200CustomData | Unset):
        status (PostExecutionsIdStopResponse200Status | Unset):
    """

    id: float | Unset = UNSET
    data: PostExecutionsIdStopResponse200Data | Unset = UNSET
    finished: bool | Unset = UNSET
    mode: PostExecutionsIdStopResponse200Mode | Unset = UNSET
    ...
    custom_data: PostExecutionsIdStopResponse200CustomData | Unset = UNSET
    status: PostExecutionsIdStopResponse200Status | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: PostExecutionsIdStopResponse200Data | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = PostExecutionsIdStopResponse200Data.from_dict(_data)
        ...
        if isinstance(_mode, Unset):
            ...
            mode = PostExecutionsIdStopResponse200Mode(_mode)
        ...
        if isinstance(_custom_data, Unset):
            ...
            custom_data = PostExecutionsIdStopResponse200CustomData.from_dict(_custom_data)
        ...
        if isinstance(_status, Unset):
            ...
            status = PostExecutionsIdStopResponse200Status(_status)

        post_executions_id_stop_response_200 = cls(
            id=id,
            data=data,
            finished=finished,
            mode=mode,
        ...
        post_executions_id_stop_response_200.additional_properties = d
        return post_executions_id_stop_response_200
