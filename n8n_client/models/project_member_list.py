...
T = TypeVar("T", bound="ProjectMemberList")
...
class ProjectMemberList:
    ...
    data: list[ProjectMember] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ProjectMember.from_dict(data_item_data)
        ...
        project_member_list = cls(
            data=data,
            next_cursor=next_cursor,
        )

        project_member_list.additional_properties = d
