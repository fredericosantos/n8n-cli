...
if TYPE_CHECKING:
    from ..models.post_workflows_response_200_nodes_item_credentials import PostWorkflowsResponse200NodesItemCredentials
    from ..models.post_workflows_response_200_nodes_item_parameters import PostWorkflowsResponse200NodesItemParameters


T = TypeVar("T", bound="PostWorkflowsResponse200NodesItem")


@_attrs_define
class PostWorkflowsResponse200NodesItem:
    """
    Attributes:
        ...
        parameters (PostWorkflowsResponse200NodesItemParameters | Unset):  Example: {'additionalProperties': {}}.
        credentials (PostWorkflowsResponse200NodesItemCredentials | Unset):  Example: {'jiraSoftwareCloudApi': {'id':
            '35', 'name': 'jiraApi'}}.
    ...
    parameters: PostWorkflowsResponse200NodesItemParameters | Unset = UNSET
    credentials: PostWorkflowsResponse200NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.post_workflows_response_200_nodes_item_credentials import (
            PostWorkflowsResponse200NodesItemCredentials,
        )
        from ..models.post_workflows_response_200_nodes_item_parameters import (
        ...
        parameters: PostWorkflowsResponse200NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = PostWorkflowsResponse200NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: PostWorkflowsResponse200NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = PostWorkflowsResponse200NodesItemCredentials.from_dict(_credentials)
        ...
        post_workflows_response_200_nodes_item = cls(
            id=id,
            name=name,
        ...
        return post_workflows_response_200_nodes_item
