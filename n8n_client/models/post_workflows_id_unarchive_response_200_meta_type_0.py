...
T = TypeVar("T", bound="PostWorkflowsIdUnarchiveResponse200MetaType0")


@_attrs_define
class PostWorkflowsIdUnarchiveResponse200MetaType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_workflows_id_unarchive_response_200_meta_type_0 = cls(
        ...
        post_workflows_id_unarchive_response_200_meta_type_0.additional_properties = d
        return post_workflows_id_unarchive_response_200_meta_type_0
