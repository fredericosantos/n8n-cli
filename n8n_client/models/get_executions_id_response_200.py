...
from ..models.get_executions_id_response_200_mode import GetExecutionsIdResponse200Mode
from ..models.get_executions_id_response_200_status import GetExecutionsIdResponse200Status
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_executions_id_response_200_custom_data import GetExecutionsIdResponse200CustomData
    from ..models.get_executions_id_response_200_data import GetExecutionsIdResponse200Data


T = TypeVar("T", bound="GetExecutionsIdResponse200")


@_attrs_define
class GetExecutionsIdResponse200:
    """
    Attributes:
        id (float | Unset):  Example: 1000.
        data (GetExecutionsIdResponse200Data | Unset): Detailed execution data. Only included when `includeData` is
            `true`.
        finished (bool | Unset):  Example: True.
        mode (GetExecutionsIdResponse200Mode | Unset):
        ...
        custom_data (GetExecutionsIdResponse200CustomData | Unset):
        status (GetExecutionsIdResponse200Status | Unset):
    """

    id: float | Unset = UNSET
    data: GetExecutionsIdResponse200Data | Unset = UNSET
    finished: bool | Unset = UNSET
    mode: GetExecutionsIdResponse200Mode | Unset = UNSET
    ...
    custom_data: GetExecutionsIdResponse200CustomData | Unset = UNSET
    status: GetExecutionsIdResponse200Status | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: GetExecutionsIdResponse200Data | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = GetExecutionsIdResponse200Data.from_dict(_data)
        ...
        if isinstance(_mode, Unset):
            ...
            mode = GetExecutionsIdResponse200Mode(_mode)
        ...
        if isinstance(_custom_data, Unset):
            ...
            custom_data = GetExecutionsIdResponse200CustomData.from_dict(_custom_data)
        ...
        if isinstance(_status, Unset):
            ...
            status = GetExecutionsIdResponse200Status(_status)

        get_executions_id_response_200 = cls(
            id=id,
            data=data,
            finished=finished,
            mode=mode,
        ...
        get_executions_id_response_200.additional_properties = d
        return get_executions_id_response_200
