...
T = TypeVar("T", bound="UpdateCredentialResponse200")


@_attrs_define
class UpdateCredentialResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_credential_response_200 = cls(
            id=id,
            name=name,
            type_=type_,
        ...
        update_credential_response_200.additional_properties = d
        return update_credential_response_200
