...
if TYPE_CHECKING:
    from ..models.put_workflows_id_response_200_active_version_type_0_nodes_item_credentials import (
        PutWorkflowsIdResponse200ActiveVersionType0NodesItemCredentials,
    )
    from ..models.put_workflows_id_response_200_active_version_type_0_nodes_item_parameters import (
        PutWorkflowsIdResponse200ActiveVersionType0NodesItemParameters,
    )


T = TypeVar("T", bound="PutWorkflowsIdResponse200ActiveVersionType0NodesItem")


@_attrs_define
class PutWorkflowsIdResponse200ActiveVersionType0NodesItem:
    """
    Attributes:
        ...
        parameters (PutWorkflowsIdResponse200ActiveVersionType0NodesItemParameters | Unset):  Example:
            {'additionalProperties': {}}.
        credentials (PutWorkflowsIdResponse200ActiveVersionType0NodesItemCredentials | Unset):  Example:
    ...
    parameters: PutWorkflowsIdResponse200ActiveVersionType0NodesItemParameters | Unset = UNSET
    credentials: PutWorkflowsIdResponse200ActiveVersionType0NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: PutWorkflowsIdResponse200ActiveVersionType0NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = PutWorkflowsIdResponse200ActiveVersionType0NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: PutWorkflowsIdResponse200ActiveVersionType0NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = PutWorkflowsIdResponse200ActiveVersionType0NodesItemCredentials.from_dict(_credentials)
        ...
        put_workflows_id_response_200_active_version_type_0_nodes_item = cls(
            id=id,
            name=name,
        ...
        return put_workflows_id_response_200_active_version_type_0_nodes_item
