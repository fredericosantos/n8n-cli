...
from ..models.post_workflows_response_200_settings_caller_policy import PostWorkflowsResponse200SettingsCallerPolicy
from ..models.post_workflows_response_200_settings_save_data_error_execution import (
    PostWorkflowsResponse200SettingsSaveDataErrorExecution,
)
from ..models.post_workflows_response_200_settings_save_data_success_execution import (
    PostWorkflowsResponse200SettingsSaveDataSuccessExecution,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostWorkflowsResponse200Settings")


@_attrs_define
class PostWorkflowsResponse200Settings:
    """
    Attributes:
        save_execution_progress (bool | Unset):
        save_manual_executions (bool | Unset):
        save_data_error_execution (PostWorkflowsResponse200SettingsSaveDataErrorExecution | Unset):
        save_data_success_execution (PostWorkflowsResponse200SettingsSaveDataSuccessExecution | Unset):
        ...
        caller_policy (PostWorkflowsResponse200SettingsCallerPolicy | Unset): Controls which workflows are allowed to
            ...
            - `workflowsFromAList`: Only specific workflows listed in the `callerIds` field can call this workflow
             ...
             Default: PostWorkflowsResponse200SettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER. Example: workflowsFromSameOwner.
    ...
    save_data_error_execution: PostWorkflowsResponse200SettingsSaveDataErrorExecution | Unset = UNSET
    save_data_success_execution: PostWorkflowsResponse200SettingsSaveDataSuccessExecution | Unset = UNSET
    execution_timeout: float | Unset = UNSET
    error_workflow: str | Unset = UNSET
    timezone: str | Unset = UNSET
    execution_order: str | Unset = UNSET
    caller_policy: PostWorkflowsResponse200SettingsCallerPolicy | Unset = (
        PostWorkflowsResponse200SettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_save_data_error_execution, Unset):
            ...
            save_data_error_execution = PostWorkflowsResponse200SettingsSaveDataErrorExecution(
        ...
        if isinstance(_save_data_success_execution, Unset):
            ...
            save_data_success_execution = PostWorkflowsResponse200SettingsSaveDataSuccessExecution(
        ...
        if isinstance(_caller_policy, Unset):
            ...
            caller_policy = PostWorkflowsResponse200SettingsCallerPolicy(_caller_policy)
        ...
        post_workflows_response_200_settings = cls(
        ...
        return post_workflows_response_200_settings
