...
from ..models.put_workflows_id_body_settings_caller_policy import PutWorkflowsIdBodySettingsCallerPolicy
from ..models.put_workflows_id_body_settings_save_data_error_execution import (
    PutWorkflowsIdBodySettingsSaveDataErrorExecution,
)
from ..models.put_workflows_id_body_settings_save_data_success_execution import (
    PutWorkflowsIdBodySettingsSaveDataSuccessExecution,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutWorkflowsIdBodySettings")


@_attrs_define
class PutWorkflowsIdBodySettings:
    """
    Attributes:
        save_execution_progress (bool | Unset):
        save_manual_executions (bool | Unset):
        save_data_error_execution (PutWorkflowsIdBodySettingsSaveDataErrorExecution | Unset):
        save_data_success_execution (PutWorkflowsIdBodySettingsSaveDataSuccessExecution | Unset):
        ...
        caller_policy (PutWorkflowsIdBodySettingsCallerPolicy | Unset): Controls which workflows are allowed to call
            this workflow using the Execute Workflow node.
            ...
            - `workflowsFromAList`: Only specific workflows listed in the `callerIds` field can call this workflow
             ...
             Default: PutWorkflowsIdBodySettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER. Example: workflowsFromSameOwner.
    ...
    save_data_error_execution: PutWorkflowsIdBodySettingsSaveDataErrorExecution | Unset = UNSET
    save_data_success_execution: PutWorkflowsIdBodySettingsSaveDataSuccessExecution | Unset = UNSET
    execution_timeout: float | Unset = UNSET
    error_workflow: str | Unset = UNSET
    timezone: str | Unset = UNSET
    execution_order: str | Unset = UNSET
    caller_policy: PutWorkflowsIdBodySettingsCallerPolicy | Unset = (
        PutWorkflowsIdBodySettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_save_data_error_execution, Unset):
            ...
            save_data_error_execution = PutWorkflowsIdBodySettingsSaveDataErrorExecution(_save_data_error_execution)
        ...
        if isinstance(_save_data_success_execution, Unset):
            ...
            save_data_success_execution = PutWorkflowsIdBodySettingsSaveDataSuccessExecution(
        ...
        if isinstance(_caller_policy, Unset):
            ...
            caller_policy = PutWorkflowsIdBodySettingsCallerPolicy(_caller_policy)
        ...
        put_workflows_id_body_settings = cls(
        ...
        return put_workflows_id_body_settings
