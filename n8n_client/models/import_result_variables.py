...
T = TypeVar("T", bound="ImportResultVariables")


@_attrs_define
class ImportResultVariables:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        import_result_variables = cls(
            added=added,
            changed=changed,
        )

        import_result_variables.additional_properties = d
        return import_result_variables
