...
if TYPE_CHECKING:
    from ..models.delete_workflows_id_response_200_active_version_type_0_nodes_item_credentials import (
        DeleteWorkflowsIdResponse200ActiveVersionType0NodesItemCredentials,
    )
    from ..models.delete_workflows_id_response_200_active_version_type_0_nodes_item_parameters import (
        DeleteWorkflowsIdResponse200ActiveVersionType0NodesItemParameters,
    )


T = TypeVar("T", bound="DeleteWorkflowsIdResponse200ActiveVersionType0NodesItem")


@_attrs_define
class DeleteWorkflowsIdResponse200ActiveVersionType0NodesItem:
    """
    Attributes:
        ...
        parameters (DeleteWorkflowsIdResponse200ActiveVersionType0NodesItemParameters | Unset):  Example:
            {'additionalProperties': {}}.
        credentials (DeleteWorkflowsIdResponse200ActiveVersionType0NodesItemCredentials | Unset):  Example:
    ...
    parameters: DeleteWorkflowsIdResponse200ActiveVersionType0NodesItemParameters | Unset = UNSET
    credentials: DeleteWorkflowsIdResponse200ActiveVersionType0NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: DeleteWorkflowsIdResponse200ActiveVersionType0NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = DeleteWorkflowsIdResponse200ActiveVersionType0NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: DeleteWorkflowsIdResponse200ActiveVersionType0NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = DeleteWorkflowsIdResponse200ActiveVersionType0NodesItemCredentials.from_dict(_credentials)
        ...
        delete_workflows_id_response_200_active_version_type_0_nodes_item = cls(
            id=id,
            name=name,
        ...
        return delete_workflows_id_response_200_active_version_type_0_nodes_item
