...
T = TypeVar("T", bound="PostExecutionsIdRetryResponse200DataRedactionInfoType0")


@_attrs_define
class PostExecutionsIdRetryResponse200DataRedactionInfoType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_executions_id_retry_response_200_data_redaction_info_type_0 = cls(
            is_redacted=is_redacted,
            reason=reason,
            can_reveal=can_reveal,
        )

        post_executions_id_retry_response_200_data_redaction_info_type_0.additional_properties = d
        return post_executions_id_retry_response_200_data_redaction_info_type_0
