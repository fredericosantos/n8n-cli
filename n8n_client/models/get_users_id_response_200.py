...
T = TypeVar("T", bound="GetUsersIdResponse200")


@_attrs_define
class GetUsersIdResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_users_id_response_200.additional_properties = d
        return get_users_id_response_200
