...
if TYPE_CHECKING:
    from ..models.post_workflows_body_nodes_item_credentials import PostWorkflowsBodyNodesItemCredentials
    from ..models.post_workflows_body_nodes_item_parameters import PostWorkflowsBodyNodesItemParameters


T = TypeVar("T", bound="PostWorkflowsBodyNodesItem")


@_attrs_define
class PostWorkflowsBodyNodesItem:
    """
    Attributes:
        ...
        parameters (PostWorkflowsBodyNodesItemParameters | Unset):  Example: {'additionalProperties': {}}.
        credentials (PostWorkflowsBodyNodesItemCredentials | Unset):  Example: {'jiraSoftwareCloudApi': {'id': '35',
            'name': 'jiraApi'}}.
    ...
    parameters: PostWorkflowsBodyNodesItemParameters | Unset = UNSET
    credentials: PostWorkflowsBodyNodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: PostWorkflowsBodyNodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = PostWorkflowsBodyNodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: PostWorkflowsBodyNodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = PostWorkflowsBodyNodesItemCredentials.from_dict(_credentials)
        ...
        post_workflows_body_nodes_item = cls(
            id=id,
            name=name,
        ...
        return post_workflows_body_nodes_item
