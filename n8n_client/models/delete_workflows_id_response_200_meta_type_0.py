...
T = TypeVar("T", bound="DeleteWorkflowsIdResponse200MetaType0")


@_attrs_define
class DeleteWorkflowsIdResponse200MetaType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_workflows_id_response_200_meta_type_0 = cls(
        ...
        delete_workflows_id_response_200_meta_type_0.additional_properties = d
        return delete_workflows_id_response_200_meta_type_0
