...
if TYPE_CHECKING:
    from ..models.put_workflows_id_body_nodes_item_credentials import PutWorkflowsIdBodyNodesItemCredentials
    from ..models.put_workflows_id_body_nodes_item_parameters import PutWorkflowsIdBodyNodesItemParameters


T = TypeVar("T", bound="PutWorkflowsIdBodyNodesItem")


@_attrs_define
class PutWorkflowsIdBodyNodesItem:
    """
    Attributes:
        ...
        parameters (PutWorkflowsIdBodyNodesItemParameters | Unset):  Example: {'additionalProperties': {}}.
        credentials (PutWorkflowsIdBodyNodesItemCredentials | Unset):  Example: {'jiraSoftwareCloudApi': {'id': '35',
            'name': 'jiraApi'}}.
    ...
    parameters: PutWorkflowsIdBodyNodesItemParameters | Unset = UNSET
    credentials: PutWorkflowsIdBodyNodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: PutWorkflowsIdBodyNodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = PutWorkflowsIdBodyNodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: PutWorkflowsIdBodyNodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = PutWorkflowsIdBodyNodesItemCredentials.from_dict(_credentials)
        ...
        put_workflows_id_body_nodes_item = cls(
            id=id,
            name=name,
        ...
        return put_workflows_id_body_nodes_item
