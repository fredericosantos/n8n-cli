...
if TYPE_CHECKING:
    from ..models.post_workflows_body_active_version_type_0_nodes_item_credentials import (
        PostWorkflowsBodyActiveVersionType0NodesItemCredentials,
    )
    from ..models.post_workflows_body_active_version_type_0_nodes_item_parameters import (
        PostWorkflowsBodyActiveVersionType0NodesItemParameters,
    )


T = TypeVar("T", bound="PostWorkflowsBodyActiveVersionType0NodesItem")


@_attrs_define
class PostWorkflowsBodyActiveVersionType0NodesItem:
    """
    Attributes:
        ...
        parameters (PostWorkflowsBodyActiveVersionType0NodesItemParameters | Unset):  Example: {'additionalProperties':
            {}}.
        credentials (PostWorkflowsBodyActiveVersionType0NodesItemCredentials | Unset):  Example:
    ...
    parameters: PostWorkflowsBodyActiveVersionType0NodesItemParameters | Unset = UNSET
    credentials: PostWorkflowsBodyActiveVersionType0NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: PostWorkflowsBodyActiveVersionType0NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = PostWorkflowsBodyActiveVersionType0NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: PostWorkflowsBodyActiveVersionType0NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = PostWorkflowsBodyActiveVersionType0NodesItemCredentials.from_dict(_credentials)
        ...
        post_workflows_body_active_version_type_0_nodes_item = cls(
            id=id,
            name=name,
        ...
        return post_workflows_body_active_version_type_0_nodes_item
