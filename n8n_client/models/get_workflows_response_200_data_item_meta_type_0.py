...
T = TypeVar("T", bound="GetWorkflowsResponse200DataItemMetaType0")


@_attrs_define
class GetWorkflowsResponse200DataItemMetaType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_workflows_response_200_data_item_meta_type_0 = cls(
        ...
        get_workflows_response_200_data_item_meta_type_0.additional_properties = d
        return get_workflows_response_200_data_item_meta_type_0
