...
from ..models.get_workflows_response_200_data_item_settings_caller_policy import (
    GetWorkflowsResponse200DataItemSettingsCallerPolicy,
)
from ..models.get_workflows_response_200_data_item_settings_save_data_error_execution import (
    GetWorkflowsResponse200DataItemSettingsSaveDataErrorExecution,
)
from ..models.get_workflows_response_200_data_item_settings_save_data_success_execution import (
    GetWorkflowsResponse200DataItemSettingsSaveDataSuccessExecution,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetWorkflowsResponse200DataItemSettings")


@_attrs_define
class GetWorkflowsResponse200DataItemSettings:
    """
    Attributes:
        save_execution_progress (bool | Unset):
        save_manual_executions (bool | Unset):
        save_data_error_execution (GetWorkflowsResponse200DataItemSettingsSaveDataErrorExecution | Unset):
        save_data_success_execution (GetWorkflowsResponse200DataItemSettingsSaveDataSuccessExecution | Unset):
        ...
        caller_policy (GetWorkflowsResponse200DataItemSettingsCallerPolicy | Unset): Controls which workflows are
            ...
            - `workflowsFromAList`: Only specific workflows listed in the `callerIds` field can call this workflow
             ...
             Default: GetWorkflowsResponse200DataItemSettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER. Example:
    ...
    save_data_error_execution: GetWorkflowsResponse200DataItemSettingsSaveDataErrorExecution | Unset = UNSET
    save_data_success_execution: GetWorkflowsResponse200DataItemSettingsSaveDataSuccessExecution | Unset = UNSET
    execution_timeout: float | Unset = UNSET
    error_workflow: str | Unset = UNSET
    timezone: str | Unset = UNSET
    execution_order: str | Unset = UNSET
    caller_policy: GetWorkflowsResponse200DataItemSettingsCallerPolicy | Unset = (
        GetWorkflowsResponse200DataItemSettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_save_data_error_execution, Unset):
            ...
            save_data_error_execution = GetWorkflowsResponse200DataItemSettingsSaveDataErrorExecution(
        ...
        if isinstance(_save_data_success_execution, Unset):
            ...
            save_data_success_execution = GetWorkflowsResponse200DataItemSettingsSaveDataSuccessExecution(
        ...
        if isinstance(_caller_policy, Unset):
            ...
            caller_policy = GetWorkflowsResponse200DataItemSettingsCallerPolicy(_caller_policy)
        ...
        get_workflows_response_200_data_item_settings = cls(
        ...
        return get_workflows_response_200_data_item_settings
