...
from ..models.post_workflows_id_activate_response_200_settings_caller_policy import (
    PostWorkflowsIdActivateResponse200SettingsCallerPolicy,
)
from ..models.post_workflows_id_activate_response_200_settings_save_data_error_execution import (
    PostWorkflowsIdActivateResponse200SettingsSaveDataErrorExecution,
)
from ..models.post_workflows_id_activate_response_200_settings_save_data_success_execution import (
    PostWorkflowsIdActivateResponse200SettingsSaveDataSuccessExecution,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostWorkflowsIdActivateResponse200Settings")


@_attrs_define
class PostWorkflowsIdActivateResponse200Settings:
    """
    Attributes:
        save_execution_progress (bool | Unset):
        save_manual_executions (bool | Unset):
        save_data_error_execution (PostWorkflowsIdActivateResponse200SettingsSaveDataErrorExecution | Unset):
        save_data_success_execution (PostWorkflowsIdActivateResponse200SettingsSaveDataSuccessExecution | Unset):
        ...
        caller_policy (PostWorkflowsIdActivateResponse200SettingsCallerPolicy | Unset): Controls which workflows are
            ...
            - `workflowsFromAList`: Only specific workflows listed in the `callerIds` field can call this workflow
             ...
             Default: PostWorkflowsIdActivateResponse200SettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER. Example:
    ...
    save_data_error_execution: PostWorkflowsIdActivateResponse200SettingsSaveDataErrorExecution | Unset = UNSET
    save_data_success_execution: PostWorkflowsIdActivateResponse200SettingsSaveDataSuccessExecution | Unset = UNSET
    execution_timeout: float | Unset = UNSET
    error_workflow: str | Unset = UNSET
    timezone: str | Unset = UNSET
    execution_order: str | Unset = UNSET
    caller_policy: PostWorkflowsIdActivateResponse200SettingsCallerPolicy | Unset = (
        PostWorkflowsIdActivateResponse200SettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_save_data_error_execution, Unset):
            ...
            save_data_error_execution = PostWorkflowsIdActivateResponse200SettingsSaveDataErrorExecution(
        ...
        if isinstance(_save_data_success_execution, Unset):
            ...
            save_data_success_execution = PostWorkflowsIdActivateResponse200SettingsSaveDataSuccessExecution(
        ...
        if isinstance(_caller_policy, Unset):
            ...
            caller_policy = PostWorkflowsIdActivateResponse200SettingsCallerPolicy(_caller_policy)
        ...
        post_workflows_id_activate_response_200_settings = cls(
        ...
        return post_workflows_id_activate_response_200_settings
