...
if TYPE_CHECKING:
    from ..models.execution_custom_data import ExecutionCustomData
...
class Execution:
    ...
    Attributes:
        ...
        data (ExecutionData | Unset): Detailed execution data. Only included when `includeData` is `true`.
        ...
        custom_data (ExecutionCustomData | Unset):
        status (ExecutionStatus | Unset):
    """

    id: float | Unset = UNSET
    data: ExecutionData | Unset = UNSET
    ...
    custom_data: ExecutionCustomData | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: ExecutionData | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = ExecutionData.from_dict(_data)
        ...
        if isinstance(_custom_data, Unset):
            ...
            custom_data = ExecutionCustomData.from_dict(_custom_data)
