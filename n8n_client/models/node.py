...
if TYPE_CHECKING:
    from ..models.node_credentials import NodeCredentials
    from ..models.node_parameters import NodeParameters
...
class Node:
    ...
    Attributes:
        ...
        parameters (NodeParameters | Unset):  Example: {'additionalProperties': {}}.
        credentials (NodeCredentials | Unset):  Example: {'jiraSoftwareCloudApi': {'id': '35', 'name': 'jiraApi'}}.
    ...
    parameters: NodeParameters | Unset = UNSET
    credentials: NodeCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: NodeParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = NodeParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: NodeCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = NodeCredentials.from_dict(_credentials)
