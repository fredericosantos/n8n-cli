...
T = TypeVar("T", bound="DeleteExecutionsIdResponse200DataRedactionInfoType0")


@_attrs_define
class DeleteExecutionsIdResponse200DataRedactionInfoType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_executions_id_response_200_data_redaction_info_type_0 = cls(
            is_redacted=is_redacted,
            reason=reason,
            can_reveal=can_reveal,
        )

        delete_executions_id_response_200_data_redaction_info_type_0.additional_properties = d
        return delete_executions_id_response_200_data_redaction_info_type_0
