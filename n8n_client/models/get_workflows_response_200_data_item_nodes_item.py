...
if TYPE_CHECKING:
    from ..models.get_workflows_response_200_data_item_nodes_item_credentials import (
        GetWorkflowsResponse200DataItemNodesItemCredentials,
    )
    from ..models.get_workflows_response_200_data_item_nodes_item_parameters import (
        GetWorkflowsResponse200DataItemNodesItemParameters,
    )


T = TypeVar("T", bound="GetWorkflowsResponse200DataItemNodesItem")


@_attrs_define
class GetWorkflowsResponse200DataItemNodesItem:
    """
    Attributes:
        ...
        parameters (GetWorkflowsResponse200DataItemNodesItemParameters | Unset):  Example: {'additionalProperties': {}}.
        credentials (GetWorkflowsResponse200DataItemNodesItemCredentials | Unset):  Example: {'jiraSoftwareCloudApi':
            {'id': '35', 'name': 'jiraApi'}}.
    ...
    parameters: GetWorkflowsResponse200DataItemNodesItemParameters | Unset = UNSET
    credentials: GetWorkflowsResponse200DataItemNodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: GetWorkflowsResponse200DataItemNodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = GetWorkflowsResponse200DataItemNodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: GetWorkflowsResponse200DataItemNodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = GetWorkflowsResponse200DataItemNodesItemCredentials.from_dict(_credentials)
        ...
        get_workflows_response_200_data_item_nodes_item = cls(
            id=id,
            name=name,
        ...
        return get_workflows_response_200_data_item_nodes_item
