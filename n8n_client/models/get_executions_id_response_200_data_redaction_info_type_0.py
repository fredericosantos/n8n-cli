...
T = TypeVar("T", bound="GetExecutionsIdResponse200DataRedactionInfoType0")


@_attrs_define
class GetExecutionsIdResponse200DataRedactionInfoType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_executions_id_response_200_data_redaction_info_type_0 = cls(
            is_redacted=is_redacted,
            reason=reason,
            can_reveal=can_reveal,
        )

        get_executions_id_response_200_data_redaction_info_type_0.additional_properties = d
        return get_executions_id_response_200_data_redaction_info_type_0
