...
from ..models.delete_workflows_id_response_200_settings_caller_policy import (
    DeleteWorkflowsIdResponse200SettingsCallerPolicy,
)
from ..models.delete_workflows_id_response_200_settings_save_data_error_execution import (
    DeleteWorkflowsIdResponse200SettingsSaveDataErrorExecution,
)
from ..models.delete_workflows_id_response_200_settings_save_data_success_execution import (
    DeleteWorkflowsIdResponse200SettingsSaveDataSuccessExecution,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteWorkflowsIdResponse200Settings")


@_attrs_define
class DeleteWorkflowsIdResponse200Settings:
    """
    Attributes:
        save_execution_progress (bool | Unset):
        save_manual_executions (bool | Unset):
        save_data_error_execution (DeleteWorkflowsIdResponse200SettingsSaveDataErrorExecution | Unset):
        save_data_success_execution (DeleteWorkflowsIdResponse200SettingsSaveDataSuccessExecution | Unset):
        ...
        caller_policy (DeleteWorkflowsIdResponse200SettingsCallerPolicy | Unset): Controls which workflows are allowed
            to call this workflow using the Execute Workflow node.
            ...
            - `workflowsFromAList`: Only specific workflows listed in the `callerIds` field can call this workflow
             ...
             Default: DeleteWorkflowsIdResponse200SettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER. Example:
    ...
    save_data_error_execution: DeleteWorkflowsIdResponse200SettingsSaveDataErrorExecution | Unset = UNSET
    save_data_success_execution: DeleteWorkflowsIdResponse200SettingsSaveDataSuccessExecution | Unset = UNSET
    execution_timeout: float | Unset = UNSET
    error_workflow: str | Unset = UNSET
    timezone: str | Unset = UNSET
    execution_order: str | Unset = UNSET
    caller_policy: DeleteWorkflowsIdResponse200SettingsCallerPolicy | Unset = (
        DeleteWorkflowsIdResponse200SettingsCallerPolicy.WORKFLOWSFROMSAMEOWNER
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_save_data_error_execution, Unset):
            ...
            save_data_error_execution = DeleteWorkflowsIdResponse200SettingsSaveDataErrorExecution(
        ...
        if isinstance(_save_data_success_execution, Unset):
            ...
            save_data_success_execution = DeleteWorkflowsIdResponse200SettingsSaveDataSuccessExecution(
        ...
        if isinstance(_caller_policy, Unset):
            ...
            caller_policy = DeleteWorkflowsIdResponse200SettingsCallerPolicy(_caller_policy)
        ...
        delete_workflows_id_response_200_settings = cls(
        ...
        return delete_workflows_id_response_200_settings
