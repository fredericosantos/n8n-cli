...
if TYPE_CHECKING:
    from ..models.post_community_packages_response_200_installed_nodes_item import (
        PostCommunityPackagesResponse200InstalledNodesItem,
    )


T = TypeVar("T", bound="PostCommunityPackagesResponse200")


@_attrs_define
class PostCommunityPackagesResponse200:
    """
    Attributes:
        ...
        installed_nodes (list[PostCommunityPackagesResponse200InstalledNodesItem] | Unset): Nodes included in this
            package
    ...
    installed_nodes: list[PostCommunityPackagesResponse200InstalledNodesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _installed_nodes is not UNSET:
            ...
            for installed_nodes_item_data in _installed_nodes:
                installed_nodes_item = PostCommunityPackagesResponse200InstalledNodesItem.from_dict(
        ...
        post_community_packages_response_200 = cls(
        ...
        post_community_packages_response_200.additional_properties = d
        return post_community_packages_response_200
