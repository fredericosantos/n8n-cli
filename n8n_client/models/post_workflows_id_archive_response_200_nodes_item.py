...
if TYPE_CHECKING:
    from ..models.post_workflows_id_archive_response_200_nodes_item_credentials import (
        PostWorkflowsIdArchiveResponse200NodesItemCredentials,
    )
    from ..models.post_workflows_id_archive_response_200_nodes_item_parameters import (
        PostWorkflowsIdArchiveResponse200NodesItemParameters,
    )


T = TypeVar("T", bound="PostWorkflowsIdArchiveResponse200NodesItem")


@_attrs_define
class PostWorkflowsIdArchiveResponse200NodesItem:
    """
    Attributes:
        ...
        parameters (PostWorkflowsIdArchiveResponse200NodesItemParameters | Unset):  Example: {'additionalProperties':
            {}}.
        credentials (PostWorkflowsIdArchiveResponse200NodesItemCredentials | Unset):  Example: {'jiraSoftwareCloudApi':
            {'id': '35', 'name': 'jiraApi'}}.
    ...
    parameters: PostWorkflowsIdArchiveResponse200NodesItemParameters | Unset = UNSET
    credentials: PostWorkflowsIdArchiveResponse200NodesItemCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters: PostWorkflowsIdArchiveResponse200NodesItemParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = PostWorkflowsIdArchiveResponse200NodesItemParameters.from_dict(_parameters)

        _credentials = d.pop("credentials", UNSET)
        credentials: PostWorkflowsIdArchiveResponse200NodesItemCredentials | Unset
        if isinstance(_credentials, Unset):
            credentials = UNSET
        else:
            credentials = PostWorkflowsIdArchiveResponse200NodesItemCredentials.from_dict(_credentials)
        ...
        post_workflows_id_archive_response_200_nodes_item = cls(
            id=id,
            name=name,
        ...
        return post_workflows_id_archive_response_200_nodes_item
