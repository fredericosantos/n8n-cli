...
if TYPE_CHECKING:
    from ..models.community_package_installed_nodes_item import CommunityPackageInstalledNodesItem


T = TypeVar("T", bound="CommunityPackage")
...
class CommunityPackage:
    ...
    Attributes:
        ...
        installed_nodes (list[CommunityPackageInstalledNodesItem] | Unset): Nodes included in this package
    ...
    installed_nodes: list[CommunityPackageInstalledNodesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _installed_nodes is not UNSET:
            ...
            for installed_nodes_item_data in _installed_nodes:
                installed_nodes_item = CommunityPackageInstalledNodesItem.from_dict(installed_nodes_item_data)
        ...
        community_package.additional_properties = d
